...
const VEO_API_KEY = import.meta.env.VITE_GEMINI_API_KEY || 'AIzaSyAEh_hNcNbBHGxgenaNXA_YdF4_Z0w-rJw';
const VEO_MODELS = {
      ...
      <Card className="lg:col-span-2">
        ...
        <CardContent className="space-y-4">
          ...
          <Alert>
            ...
            <AlertDescription>
              Veo 3 là model video AI tiên tiến nhất của Google, hỗ trợ tạo video có âm thanh tự động.
              Chi phí ~$0.40/video (8 giây). Model được train với hàng triệu video chất lượng cao.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
