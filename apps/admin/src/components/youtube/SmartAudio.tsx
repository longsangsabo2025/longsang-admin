...
function wrapPcmInWav(pcmData: Uint8Array, sampleRate = 24000, numChannels = 1, bitsPerSample = 16): Blob {
...
export default function SmartAudio({ src, className, onRegenerate, regenerating, showDownload = true, showRegenerate = true }: SmartAudioProps) {
  ...
  return (
    <div className={`flex items-center gap-1.5 ${className || ''}`}>
      <audio ref={audioRef} controls src={blobUrl || undefined} className="h-7 flex-1 min-w-0" preload="auto" />
