...
import { TrendingUp, Zap, Database, Bot, Key, Crown, AlertCircle } from 'lucide-react';
        ...
        <CardContent className="space-y-6">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                className={`text-sm font-mono ${getUsageColor(getUsagePercentage(currentUsage.api_calls_count, plan?.max_api_calls || 1))}`}
              >
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                className={`text-sm font-mono ${getUsageColor(getUsagePercentage(currentUsage.workflows_executed, plan?.max_workflows || 1))}`}
              >
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                className={`text-sm font-mono ${getUsageColor(getUsagePercentage(currentUsage.agents_created, plan?.max_agents || 1))}`}
              >
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                className={`text-sm font-mono ${getUsageColor(getUsagePercentage(currentUsage.storage_used_mb, plan?.max_storage_mb || 1))}`}
              >
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                className={`text-sm font-mono ${getUsageColor(getUsagePercentage(currentUsage.credentials_stored, plan?.max_credentials || 1))}`}
              >
