...
const VIDEO_PROVIDER_OPTIONS = [
  { id: 'google' as const, name: '🔵 Google Direct', description: 'VEO 3.1 - $0.40/video', color: 'blue' },
  { id: 'kie' as const, name: '🟣 Kie.ai', description: 'VEO 3 Fast - $0.40/video', color: 'purple' },
] as const;
