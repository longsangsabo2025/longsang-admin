...
export const CONTENT_TEMPLATES: ContentTemplate[] = [
  {
    ...
    category: 'intro',
    script: 'Xin chào! Tôi là Long Sang, người sáng lập SABO Arena - hệ thống billiard club hiện đại nhất Việt Nam. Hôm nay tôi muốn chia sẻ với các bạn...',
    duration: 15,
    platform: 'all',
  },
  {
    ...
    category: 'promo',
    script: 'SABO Arena có tin hot cho các bạn! Cuối tuần này chúng tôi tổ chức giải đấu billiard với giải thưởng lên đến 50 triệu đồng...',
    duration: 30,
    platform: 'tiktok',
  },
  {
    ...
    category: 'tutorial',
    script: 'Bạn muốn cải thiện kỹ năng billiard? Đây là tip mà các pro player tại SABO Arena thường sử dụng...',
    duration: 45,
    platform: 'youtube',
  },
  {
    ...
    script: 'Tin vui! SABO Arena vừa khai trương chi nhánh mới tại [địa điểm]. Đặc biệt, trong tuần đầu tiên chúng tôi có chương trình...',
    duration: 20,
    platform: 'facebook',
  },
];
...
export const GENERATION_STYLES: GenerationStyle[] = [
  { id: 'professional', name: '💼 Professional', prompt: 'professional business attire, corporate setting, confident pose' },
  { id: 'casual', name: '😊 Casual Friendly', prompt: 'casual attire, friendly smile, relaxed atmosphere' },
  { id: 'sporty', name: '🏀 Sporty', prompt: 'athletic wear, billiard club setting, energetic' },
  { id: 'presenter', name: '🎤 Presenter', prompt: 'presenter pose, speaking gesture, engaging expression' },
];
