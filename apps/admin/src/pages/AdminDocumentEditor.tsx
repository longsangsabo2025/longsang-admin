...
const AdminDocumentEditor = () => {
  ...
  const [blocks, setBlocks] = useState<Block[]>([
    ...
    },
    {
      ...
      type: 'paragraph',
      content:
        'This is a Notion-like editor for creating and managing documents. You can add different types of blocks to build rich content.',
    },
  ]);
            ...
            <Card>
              ...
              <CardContent className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <Badge className={getStatusColor(selectedDoc.status)}>{selectedDoc.status}</Badge>
                </div>
                <div className="flex justify-between">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-2xl">{documents.filter((d) => d.starred).length}</CardTitle>
          </CardHeader>
        </Card>
      </div>
