      ...
      <Card className="bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 border-none">
        <CardContent className="py-4">
          ...
          <p className="text-xs text-muted-foreground mt-3">
            💡 <strong>Tip:</strong> Preview script trước để kiểm tra nội dung. Voice sử dụng Edge TTS (miễn phí, chất lượng cao).
          </p>
        </CardContent>
      </Card>
                  ...
                  <div className="space-y-4">
                    <div className="p-4 bg-blue-500/10 rounded-lg">
                      ...
                      <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
                        <li>Nhập <strong>chủ đề</strong> video (VD: "Cách kiếm tiền online 2026")</li>
                        <li>Chọn <strong>giọng đọc</strong> (Tiếng Việt hoặc English)</li>
                        <li>Đặt <strong>thời lượng</strong> mong muốn (15-300 giây)</li>
                        <li>Click <strong>"Preview Script"</strong> để xem nội dung AI viết</li>
                        <li>Click <strong>"Create Video"</strong> để bắt đầu sản xuất</li>
                      </ol>
                    </div>
                    ...
                    <div className="p-4 bg-purple-500/10 rounded-lg">
                      ...
                      <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
                        <li>Nhập nhiều chủ đề, <strong>mỗi dòng 1 chủ đề</strong></li>
                    ...
                    <div className="p-4 bg-green-500/10 rounded-lg">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                        <li><strong>Script:</strong> Nội dung video do AI viết</li>
                        <li><strong>Audio MP3:</strong> File giọng đọc (Edge TTS - miễn phí)</li>
                        <li>Click <strong>Play</strong> để nghe, <strong>Download</strong> để tải về</li>
                      </ul>
                    </div>
                    ...
                    <div className="p-4 bg-muted rounded-lg">
                      ...
                      <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
                        <li>Service chạy trên port <code className="bg-background px-1 rounded">3012</code></li>
                        <li>Cần có <code className="bg-background px-1 rounded">OPENAI_API_KEY</code> trong .env</li>
