...
// Type-safe table accessors using Supabase generated types
const aiAgentsTable = () => supabase.from('ai_agents');
const workflowsTable = () => supabase.from('workflows');
const workflowExecutionsTable = () => supabase.from('workflow_executions');
