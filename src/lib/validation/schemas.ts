...
export const CreateAgentSchema = z.object({
  ...
  type: z.enum(['content_writer', 'lead_nurture', 'social_media', 'analytics', 'research', 'code_review', 'personal_assistant']),
...
export const SEOPageSchema = z.object({
  ...
  description: z.string().min(50, 'Description too short').max(160, 'Description too long (max 160 chars)'),
