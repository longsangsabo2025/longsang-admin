...
export function KeywordTracker() {
  const keywords = [
    { keyword: "cơ thủ bi-a việt nam", position: 3, change: 2, volume: "Medium", difficulty: "★★☆" },
    ...
    { keyword: "giải đấu bi-a việt nam", position: 12, change: 5, volume: "Medium", difficulty: "★★☆" },
  ];
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Ranking của keywords quan trọng trên Google
        </CardDescription>
      </CardHeader>
      <CardContent>
