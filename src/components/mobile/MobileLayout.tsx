...
import { Home, GitBranch, MessageSquare, FolderOpen, Rocket, Settings } from 'lucide-react';
      ...
      <header className="sticky top-0 z-50 bg-gray-900/95 backdrop-blur-sm border-b border-gray-800 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold truncate">{title || 'LongSang Admin'}</h1>
          </div>
          <Link
            to="/mobile/settings"
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? 'text-blue-400 bg-blue-500/10' : 'text-gray-500 hover:text-gray-300'
                )}
              >
