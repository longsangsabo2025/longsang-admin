...
export const projectsData: ProjectData[] = [
  ...
  // Long Sang Portfolio - Main Portfolio Website
  {
    ...
    heroDescription: "Portfolio Website chuyên nghiệp với AI Marketplace, Academy đào tạo AI và Investment Portal cho các dự án công nghệ",
    heroStats: [
    ...
    overviewTitle: "TỔNG QUAN DỰ ÁN",
    overviewDescription: "Long Sang Portfolio là nền tảng portfolio đa năng, tích hợp AI Marketplace để khám phá và kích hoạt các AI Agents, Academy cho các khóa học AI, và Investment Portal để thu hút đầu tư cho các dự án công nghệ.",
    objectives: [
    ...
    techStack: [
      ...
      { name: "TanStack Query", category: "State", icon: Zap, iconifyIcon: "logos:react-query-icon" },
      { name: "Framer Motion", category: "Animation", icon: Zap, iconifyIcon: "tabler:brand-framer-motion" },
