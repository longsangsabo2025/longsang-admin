        ...
        <div className="space-y-24">
          {roadmapPhases.map((phase, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`lg:grid lg:grid-cols-2 gap-12 items-center ${!isLeft && 'lg:grid-flow-dense'}`}
                >
                  {/* Content Card */}
      ...
      >
        <GlowCard className="p-12 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Chúng tôi cập nhật tiến độ hàng quý với báo cáo chi tiết cho nhà đầu tư. Tất cả
            milestones đều được tracking công khai và minh bạch.
          </p>
        </GlowCard>
      </motion.div>
    </div>
