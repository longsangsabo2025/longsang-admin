  ...
  return (
    <div className="container mx-auto py-16 px-4">
      ...
      <div className="text-center mb-12">
        ...
        <Tabs value={paymentMethod} onValueChange={(v) => setPaymentMethod(v as 'stripe' | 'vnpay')} className="w-full max-w-md mx-auto mb-8">
          ...
          return (
            ...
            >
                ...
                <div className="mt-6">
                  ...
                  {plan.price_yearly > 0 && (
                    <p className="text-sm text-muted-foreground mt-2">
                      or ${plan.price_yearly}/year (save ${Math.round((plan.price_monthly * 12) - plan.price_yearly)})
                    </p>
                  )}
                </div>
              </CardHeader>
              ...
              <CardFooter>
                ...
                >
                  {loading ? 'Processing...' : isCurrentPlan ? 'Current Plan' : plan.name === 'free' ? 'Get Started' : 'Upgrade Now'}
                </Button>
              </CardFooter>
            </Card>
          );
