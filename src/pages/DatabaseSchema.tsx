  ...
  return (
    <div className="container max-w-4xl mx-auto py-8 space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">Verify database tables and structure</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Verify which tables exist in your Supabase database</CardDescription>
        </CardHeader>
        <CardContent>
          <Button onClick={checkDatabase} disabled={loading} size="lg" className="w-full">
            {loading ? (
              <>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-sm text-muted-foreground">need to be created</p>
            </CardContent>
          </Card>
        </div>
      )}
      ...
      {tables.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Detailed information about each table</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
      ...
      {missingTables.length > 0 && tables.length > 0 && (
        <Card className="border-orange-500">
          <CardHeader>
            ...
            <CardDescription>Some tables are missing. You need to run migrations.</CardDescription>
          </CardHeader>
      ...
      {existingTables.length === expectedTables.length && tables.length > 0 && (
        <Card className="border-green-500 bg-green-50">
          <CardHeader>
            <CardTitle className="text-green-600 flex items-center gap-2">
              <CheckCircle2 className="h-6 w-6" />✅ Database is ready!
            </CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              <Button onClick={() => (window.location.href = '/automation')} className="w-full">
