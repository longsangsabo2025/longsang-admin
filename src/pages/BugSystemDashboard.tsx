...
export default function BugSystemDashboard() {
  ...
  const handleAutoFix = async () => {
    ...
    toast({
      ...
      description: 'Running auto-fix system...',
    });
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: `Fixed ${result.fixed} errors, skipped ${result.skipped}`,
        });
      } else {
        toast({
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={handleAutoFix} disabled={fixing} size="sm">
            <Play className="h-4 w-4 mr-2" />
            {fixing ? 'Running...' : 'Run Auto-Fix'}
          </Button>
        </div>
      </div>
