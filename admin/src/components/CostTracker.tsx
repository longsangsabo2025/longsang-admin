    ...
    return (
      <Card className="border-red-200 dark:border-red-800">
        <CardContent className="pt-6">
          <p className="text-sm text-red-600 dark:text-red-400">Failed to load cost data</p>
        </CardContent>
      </Card>
    );
  }
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        {/* Total Cost */}
        <div>
          <div className="text-2xl font-bold tracking-tight">{formatCurrency(costData.total)}</div>
