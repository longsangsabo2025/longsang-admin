import { Award, Briefcase, Calendar, GraduationCap, Mail, MapPin, Settings } from 'lucide-react';
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="space-y-6 text-lg text-foreground-secondary leading-relaxed">
              <p>
                ...
                <span className="text-primary font-semibold">extensive experience</span> in building
                web and mobile applications integrated with AI. Currently developing innovative
                solutions at <span className="text-secondary font-semibold">AINewbieVN</span> while
                managing <span className="text-accent font-semibold">SABO Billiards</span> as Owner
                & Manager.
              </p>
              ...
              <p>
                ...
                <span className="text-accent font-semibold">
                  full-stack development, AI integration, and mobile app development
                </span>{' '}
                using cutting-edge technologies like React, TypeScript, Flutter, Node.js, and
                PostgreSQL. Expert in building real-time systems, designing scalable architectures,
                and deploying production applications on AWS, Firebase, and Vercel.
              </p>

              <p>
                Passionate about leveraging technology to solve real-world problems through
                automation and intelligent systems. Strong background in both technical engineering
                and business development, with a proven track record in creating user-centric
