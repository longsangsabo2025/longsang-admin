...
import { formatDate, formatSize, getPreviewUrl, typeConfig } from './utils';
          ...
          {previewItem && (
            <div className="p-4 bg-background flex items-center justify-between">
              <div className="flex items-center gap-3 min-w-0">
                <Badge
                  className={`${typeConfig[previewItem.type].bg} ${typeConfig[previewItem.type].color} border ${typeConfig[previewItem.type].border}`}
                >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    {previewItem.modifiedTime && `• ${formatDate(previewItem.modifiedTime)}`}
                  </p>
                </div>
              </div>
