...
const GoogleServicesPage = lazy(() => import('@/pages/marketing/GoogleServices'));
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <TabsList className="flex flex-wrap h-auto gap-1">
          ...
          <TabsTrigger value="google-services">🌐 Google Services</TabsTrigger>
        ...
        {/* Google Services Tab */}
        <TabsContent value="google-services">
          <Suspense
            fallback={
