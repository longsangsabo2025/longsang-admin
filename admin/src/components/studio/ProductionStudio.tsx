import { AlertCircle, Check, ChevronRight, Clock, Play, Sparkles } from 'lucide-react';
...
const AGENT_FLOW = [
  {
    ...
    description: 'Analyzing script structure',
    icon: '📝',
  },
  ...
  { id: 'editor', name: 'Video Editor', description: 'Creating motion prompts', icon: '✂️' },
  {
    ...
    description: 'Validating consistency',
    icon: '✓',
  },
];
    ...
    <div className="flex h-full gap-4">
      ...
      <div className="w-80 border-r pr-4">
        <div className="mb-4">
          ...
          <Button onClick={runFullPipeline} disabled={isRunning} className="w-full" size="lg">
            {isRunning ? (
              <>
