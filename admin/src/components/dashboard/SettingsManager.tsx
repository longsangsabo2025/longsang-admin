...
const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    description:
      'Credentials for Telegram (admin alerts + seeding), Twitter, Facebook, Reddit, and Forlike',
    fields: [
      {
      ...
      <Card>
          ...
          <CardHeader className="cursor-pointer hover:bg-muted/50 transition-colors">
            <div className="flex items-center justify-between">
              ...
              <Badge
                ...
                className={configuredCount === totalCount ? 'bg-green-600 hover:bg-green-700' : ''}
              >
        ...
        <CollapsibleContent>
          <CardContent className="space-y-5 pt-2">
            ...
            {section.testButton && (
              <Button variant="outline" className="w-full mt-2" onClick={onTest} disabled={testing}>
                {testing ? (
            ...
            {section.id === 'youtube' && (
              <div className="p-3 bg-muted/50 rounded-lg text-xs text-muted-foreground space-y-1">
                ...
                <ol className="list-decimal list-inside space-y-0.5">
                  ...
                  <li>
                    Add redirect URI: <code>http://localhost:8080/oauth2callback</code>
                  </li>
