...
import { Activity, Bot, DollarSign, Filter, Plus, Search, TrendingUp } from 'lucide-react';
...
import { AgentType, AIAgent } from '@/types/agent-center.types';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400">Quản lý và giám sát các AI agents của bạn</p>
        </div>
