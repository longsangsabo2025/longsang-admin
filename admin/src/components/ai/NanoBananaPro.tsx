...
import { Banana, Copy, Download, Loader2, RefreshCw, Sparkles, Zap } from 'lucide-react';
...
const STYLE_PRESETS = [
  ...
  },
  {
    id: 'digital-art',
    name: '🎨 Digital Art',
    prompt: 'digital art, concept art, detailed illustration, artstation quality',
  },
  {
    id: 'anime',
    name: '🎌 Anime',
    prompt: 'anime style, detailed anime illustration, vibrant colors, studio quality',
  },
  {
    id: 'oil-painting',
    name: '🖼️ Oil Painting',
    prompt: 'oil painting style, classical art, brush strokes, canvas texture',
  },
  {
    id: 'watercolor',
    name: '💧 Watercolor',
    prompt: 'watercolor painting, soft gradients, artistic, delicate',
  },
  {
    id: '3d-render',
    name: '🧊 3D Render',
    prompt: '3D render, octane render, volumetric lighting, highly detailed',
  },
  {
    id: 'minimalist',
    name: '⬜ Minimalist',
    prompt: 'minimalist design, clean lines, simple, elegant, modern',
  },
  {
    id: 'cyberpunk',
    name: '🌃 Cyberpunk',
    prompt: 'cyberpunk style, neon lights, futuristic, sci-fi, dark atmosphere',
  },
];
        ...
        {result && (
          <div className="space-y-3">
            <div className="relative rounded-lg overflow-hidden border bg-muted/20">
              <img src={result} alt="Generated by Nano Banana Pro" className="w-full h-auto" />
              {generationTime && (
