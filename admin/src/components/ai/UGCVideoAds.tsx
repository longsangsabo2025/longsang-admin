...
const ICP_PRESETS = [
  {
    id: 'young-woman',
    label: 'Phụ nữ trẻ 20-30',
    value: 'Young woman, 20-30 years old, casual attire, friendly smile',
  },
  {
    id: 'young-man',
    label: 'Nam giới trẻ 20-30',
    value: 'Young man, 20-30 years old, casual style, confident look',
  },
  {
    id: 'professional',
    label: 'Chuyên gia/Office',
    value: 'Professional adult, 30-40 years old, business casual, trustworthy appearance',
  },
  {
    id: 'fitness',
    label: 'Fitness/Gym',
    value: 'Fitness enthusiast, athletic build, sportswear, energetic personality',
  },
  {
    id: 'mother',
    label: 'Mẹ bỉm sữa',
    value: 'Young mother, 25-35 years old, warm and caring, home environment',
  },
  {
    id: 'student',
    label: 'Sinh viên',
    value: 'College student, 18-24 years old, casual trendy style, youthful energy',
  },
];
...
const SETTING_PRESETS = [
  {
    id: 'kitchen',
    label: '🍳 Nhà bếp',
    value: 'Modern bright kitchen, natural morning light, cozy home atmosphere',
  },
  {
    id: 'bedroom',
    label: '🛏️ Phòng ngủ',
    value: 'Cozy bedroom, soft natural light, relaxed home setting',
  },
  {
    id: 'bathroom',
    label: '🚿 Phòng tắm',
    value: 'Clean modern bathroom, bright lighting, fresh atmosphere',
  },
  {
    id: 'office',
    label: '💼 Văn phòng',
    value: 'Modern office space, professional environment, good lighting',
  },
  {
    id: 'gym',
    label: '🏋️ Phòng gym',
    value: 'Fitness gym, workout equipment, energetic atmosphere',
  },
  {
    id: 'outdoor',
    label: '🌳 Ngoài trời',
    value: 'Beautiful outdoor setting, natural sunlight, fresh environment',
  },
  {
    id: 'car',
    label: '🚗 Trong xe',
    value: 'Inside car, natural daylight through window, casual setting',
  },
  {
    id: 'cafe',
    label: '☕ Quán cafe',
    value: 'Cozy cafe, warm ambient lighting, relaxed atmosphere',
  },
];
...
export function UGCVideoAds({ selectedLibraryImage }: UGCVideoAdsProps) {
  ...
  const handleGenerate = useCallback(async () => {
    ...
    try {
      ...
      const response = await createUGCVideoAd(
        input,
        (status) => {
        ...
        <div className="p-6 space-y-6">
          ...
          <Collapsible open={showAISettings} onOpenChange={setShowAISettings}>
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Tùy chỉnh AI để tạo prompt video tốt hơn</CardDescription>
              </CardHeader>
              <CollapsibleContent>
                <CardContent className="space-y-4 pt-0">
                  ...
                  {/* Reset Button */}
                  <Button variant="outline" size="sm" onClick={resetAISettings} className="w-full">
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>Mô tả người sẽ xuất hiện trong video</CardDescription>
            </CardHeader>
              ...
              <CardContent className="pt-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    {selectedModelInfo?.steps === 2 ? 'Đang tạo ảnh UGC → Video' : 'Đang tạo video'}
                  </p>
                </div>
              </CardContent>
            </Card>
                  ...
                  {history.slice(0, 5).map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-medium text-sm truncate">{item.request.product}</div>
