...
const STYLE_PRESETS = [
  {
    id: 'realistic',
    name: '📸 Realistic',
    prompt: 'photorealistic, highly detailed, 8K, professional photography',
  },
  {
    id: 'cinematic',
    name: '🎬 Cinematic',
    prompt: 'cinematic lighting, dramatic composition, movie still, film grain',
  },
  {
    id: 'anime',
    name: '🎌 Anime',
    prompt: 'anime style, vibrant colors, detailed illustration, studio ghibli inspired',
  },
  {
    id: 'digital-art',
    name: '🎨 Digital Art',
    prompt: 'digital art, concept art, highly detailed, artstation trending',
  },
  {
    id: '3d-render',
    name: '🧊 3D Render',
    prompt: '3D render, octane render, unreal engine, highly detailed, volumetric lighting',
  },
  {
    id: 'oil-painting',
    name: '🖼️ Oil Painting',
  ...
  },
  {
    id: 'watercolor',
    name: '💧 Watercolor',
    prompt: 'watercolor painting, soft colors, artistic, delicate brush strokes',
  },
  {
    id: 'minimalist',
    name: '⬜ Minimalist',
    prompt: 'minimalist design, clean lines, simple, elegant, modern aesthetic',
  },
];
...
export function TextToImage({ onGenerated }: TextToImageProps) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const fullPrompt = stylePreset ? `${prompt}, ${stylePreset.prompt}` : prompt;
