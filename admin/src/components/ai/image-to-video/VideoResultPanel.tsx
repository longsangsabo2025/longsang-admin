          ...
          {result?.state === 'success' && result.videoUrl ? (
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <Button variant="outline" onClick={onSaveToDrive} disabled={isSavingToDrive}>
                  {isSavingToDrive ? <Loader2 className="h-4 w-4 animate-spin" /> : <>☁️ Drive</>}
                </Button>
                <Button
                  variant="outline"
            ...
            <div className="flex flex-col items-center justify-center h-64">
              ...
              <p className="text-sm text-muted-foreground mt-1">Video có thể mất 1-3 phút để tạo</p>
            </div>
          ) : (
