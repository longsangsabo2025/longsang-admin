import { Clock, Film, Loader2, RefreshCw, Settings2, Sliders, Sparkles, Wand2 } from 'lucide-react';
    ...
    <>
      ...
      <Collapsible open={showAISettings} onOpenChange={onShowAISettingsChange}>
        ...
        <CollapsibleContent className="pt-3 space-y-4">
          ...
          {/* Reset to defaults */}
          <Button variant="ghost" size="sm" onClick={onResetAISettings} className="w-full">
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          {/* Motion Presets */}
          <div>
            <Label className="text-xs text-muted-foreground mb-2 block">Kiểu chuyển động</Label>
                      ...
                      {['16:9', '9:16', '1:1'].map((ratio) => (
                        <Button
                          ...
                          onClick={() => {
                            ...
                            if (ratio === '1:1') {
                              toast.info(
                                '⚠️ Veo3 có thể không hỗ trợ tốt tỷ lệ 1:1, kết quả có thể là 16:9'
                              );
                            }
                          }}
                        >
