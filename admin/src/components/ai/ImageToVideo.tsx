...
import { Image as ImageIcon, Loader2, Sparkles, Trash2, Upload, Video } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="space-y-4">
          <VideoModelSelector selectedModel={selectedModel} onModelChange={setSelectedModel} />
          ...
          <Card>
            <CardHeader className="pb-3">
              ...
              <CardDescription>Upload hoặc chọn từ Thư Viện bên trái</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                ...
                {previewUrl && (
                  <div className="relative aspect-video rounded-lg overflow-hidden border bg-muted">
                    ...
                    {libraryImageUrl && (
                      <Badge className="absolute top-2 left-2 bg-blue-500">Từ Thư Viện</Badge>
                    )}
                  </div>
                )}
