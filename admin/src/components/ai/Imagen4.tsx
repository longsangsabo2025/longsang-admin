...
const STYLE_PRESETS = [
  { id: 'none', name: 'Không có', suffix: '' },
  {
    id: 'photorealistic',
    name: 'Chân thực',
    suffix: ', photorealistic, highly detailed, 8k resolution',
  },
  {
    id: 'digital-art',
    name: 'Digital Art',
    suffix: ', digital art style, vibrant colors, detailed illustration',
  },
  {
    id: 'anime',
    name: 'Anime',
    suffix: ', anime style, detailed anime art, Studio Ghibli inspired',
  },
  {
    id: 'watercolor',
    name: 'Watercolor',
    suffix: ', watercolor painting style, soft colors, artistic',
  },
  {
    id: 'oil-painting',
    name: 'Sơn dầu',
    suffix: ', oil painting style, classic art, rich textures',
  },
  {
    id: 'minimalist',
    name: 'Tối giản',
    suffix: ', minimalist design, clean lines, simple composition',
  },
  {
    id: '3d-render',
    name: '3D Render',
    suffix: ', 3D render, octane render, highly detailed, realistic lighting',
  },
];
