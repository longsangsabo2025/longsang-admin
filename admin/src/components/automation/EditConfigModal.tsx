    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) => updateConfig('max_length', parseInt(e.target.value, 10))}
          min="100"
          max="10000"
        />
      </div>
    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) => updateConfig('follow_up_delay_hours', parseInt(e.target.value, 10))}
          min="1"
          max="168"
        />
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) => updateConfig('max_follow_ups', parseInt(e.target.value, 10))}
          min="1"
          max="10"
        />
      </div>
    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) => updateConfig('post_variants', parseInt(e.target.value, 10))}
          min="1"
          max="10"
        />
