...
import { Calendar, Hash, Image as ImageIcon, Loader2, Send, Sparkles, Zap } from 'lucide-react';
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Tạo và đăng bài nhanh chóng lên nhiều nền tảng cùng lúc</CardDescription>
      </CardHeader>
