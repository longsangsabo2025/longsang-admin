...
import { FileText, Loader2, Megaphone, Package, Rocket } from 'lucide-react';
      ...
      <DialogContent className="max-w-lg" aria-describedby="create-pack-description">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              placeholder="VD: Sports, Real Estate, AI..."
              value={newPackInfo.category}
          ...
          <div className="space-y-2">
            ...
            <Input
              placeholder="VD: Nền tảng bida số 1 Việt Nam"
              value={newPackInfo.oneLiner}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              value={newPackInfo.targetMarket}
      ...
      <DialogContent className="max-w-lg" aria-describedby="create-campaign-description">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              placeholder="VD: Launch Campaign Q1 2025"
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => onCampaignChange({ ...newCampaign, content: e.target.value })}
