...
import { CheckCircle2, Clock, Copy, Edit, Eye, Loader2, Send } from 'lucide-react';
...
import type { EditingPost, ScheduledPost } from './types';
        ...
        {post && (
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 rounded-lg bg-muted/50">
              ...
              <Badge
                className={cn('text-white', STATUS_CONFIG[post.status]?.color || 'bg-gray-500')}
              >
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  onEditingPostChange({ ...editingPost, scheduled_at: e.target.value })
                }
              ...
              {[
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    onEditingPostChange({
                      ...editingPost,
                      scheduled_at: newTime.toISOString().slice(0, 16),
                    });
                  }}
                >
                  {label}
            ...
            <div className="flex gap-2 justify-end pt-4 border-t">
              ...
              <Button
                onClick={onSavePost}
                disabled={savingPost || !editingPost.content.trim()}
                className="gap-2"
              >
                {savingPost ? (
