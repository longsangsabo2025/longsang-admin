...
const AutoPublishDashboard = lazy(() => import('./AutoPublishDashboard'));
...
import { INDIE_HACKERS, LINKEDIN, TWITTER } from '@/brain/data/social-media-kit';
    ...
    switch (templateKey) {
      ...
      default: {
        ...
        content = template
          ...
          .replace(
            '{products}',
            BRAND_PROFILE.products.map((p) => `${p.emoji} ${p.name}`).join('\n')
          )
          .replace(
            '{productList}',
            BRAND_PROFILE.products.map((p) => `• ${p.emoji} ${p.name} (${p.status})`).join('\n')
          )
          .replace('{techStack}', BRAND_PROFILE.skills.technical.join(', '))
          .replace(
            '{productDescriptions}',
            BRAND_PROFILE.products
              .map(
                (p) =>
    ...
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Build your personal brand with AI-powered tools</p>
          </div>
        </div>
        ...
        <div className="mt-4 p-4 bg-muted/50 rounded-lg">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm text-muted-foreground">
              {setupComplete}/{setupTotal} platforms
            </span>
          </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        <TabsList className="grid w-full grid-cols-5 h-auto">
          ...
          <TabsTrigger value="publish" className="flex items-center gap-2 py-3">
            📤<span className="hidden sm:inline">Auto Publish</span>
          </TabsTrigger>
        </TabsList>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      📍 {BRAND_PROFILE.personal.location}
                    </p>
                  </div>
                </div>
                <Separator />
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {BRAND_PROFILE.skills.ai.map((skill) => (
                      <Badge key={skill} variant="outline" className="border-purple-500">
                        {skill}
                      </Badge>
                    ))}
                  </div>
        ...
        <TabsContent value="assets" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Generate consistent brand images with AI</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-3">
                <Button variant="outline" className="h-32 flex-col gap-2" asChild>
                  <a href="/admin/brain" target="_blank" rel="noopener">
                ...
                <Button variant="outline" className="h-32 flex-col gap-2" asChild>
                  <a href="/admin/image-generator" target="_blank" rel="noopener">
                  ...
                  {[
                    {
                      ...
                      prompt:
                        'Professional headshot of Asian male developer, confident smile, wearing casual smart clothes, gradient blue-purple background, high quality, 4K',
                    },
                    {
                      id: 'prompt-logo',
                      title: 'Brand Logo',
                      prompt:
                        'Modern minimalist logo for "LongSang Automation", tech startup, AI and automation theme, blue and purple gradient, clean design',
                    },
                    {
                      id: 'prompt-banner',
                      title: 'Twitter Banner',
                      prompt:
                        'Twitter banner 1500x500, modern tech aesthetic, "AI-Powered Automation for Solo Founders" text, gradient blue to purple, minimalist',
                    },
                  ].map((item) => (
        ...
        <TabsContent value="content" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Generate platform-specific bios and content</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" variant="outline" onClick={() => generateContent('twitterBio')}>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setGeneratedContent((prev) => ({ ...prev, twitterBio: e.target.value }))
                  }
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" variant="outline" onClick={() => generateContent('firstTweet')}>
                    <Wand2 className="h-4 w-4 mr-1" />
                    Generate
                  </Button>
                </div>
                <Textarea
                  ...
                  onChange={(e) =>
                    setGeneratedContent((prev) => ({ ...prev, firstTweet: e.target.value }))
                  }
              ...
              <div className="space-y-3">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setGeneratedContent((prev) => ({ ...prev, linkedinAbout: e.target.value }))
                  }
                ...
                {generatedContent.linkedinAbout && (
                  <Button
                    ...
                    variant="ghost"
                    onClick={() =>
                      copyToClipboard(generatedContent.linkedinAbout, 'linkedin-about')
                    }
                  >
                    {copiedId === 'linkedin-about' ? (
                      <Check className="h-4 w-4 mr-1" />
                    ) : (
                      <Copy className="h-4 w-4 mr-1" />
                    )}
              ...
              <div className="space-y-3">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setGeneratedContent((prev) => ({ ...prev, indiehackersIntro: e.target.value }))
                  }
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Recommended posting schedule for maximum engagement</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {[
                  {
                    day: 'Monday',
                    platform: 'Twitter',
                    content: 'Weekly goals thread',
                    Icon: Target,
                  },
                  {
                    day: 'Tuesday',
                    platform: 'Twitter',
                    content: 'Tech tip or code snippet',
                    Icon: Zap,
                  },
                  {
                    day: 'Wednesday',
                    platform: 'YouTube',
                    content: 'Tutorial or demo video',
                    Icon: Camera,
                  },
                  {
                    day: 'Thursday',
                  ...
                  },
                  {
                    ...
                    content: 'Weekly revenue/metrics update',
                    Icon: TrendingUp,
                  },
                  {
                    day: 'Saturday',
                  ...
                  },
                  {
                    day: 'Sunday',
                    platform: 'LinkedIn',
                    content: 'Reflection/lesson learned',
                    Icon: FileText,
                  },
                ].map((item) => (
                  <div
        ...
        <TabsContent value="strategy" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Step-by-step guide to set up your social presence</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Focus product: Billiard tournament management</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {/* Target Market */}
              <div>
                  ...
                  {[
                    {
                      ...
                      priority: 'HIGH',
                      reason: 'Billiard communities very active',
                    },
                    {
                      channel: 'Zalo OA',
                      priority: 'HIGH',
                      reason: 'Most used messaging app in VN',
                    },
                    {
                      channel: 'TikTok',
                      priority: 'MEDIUM',
                      reason: 'Short billiard trick videos',
                    },
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Complete these tasks to launch your brand</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                {[
                  {
                    id: 'task-1',
                    task: 'Create Owner Portrait in Brain Library',
                    link: '/admin/brain',
                    done: false,
                  },
                  {
                    id: 'task-2',
                    task: 'Set up Twitter/X account @LongSangDev',
                    link: 'https://twitter.com/i/flow/signup',
                    done: false,
                  },
                  {
                    id: 'task-3',
                    task: 'Create IndieHackers profile',
                    link: 'https://www.indiehackers.com/start',
                    done: false,
                  },
                  {
                    id: 'task-4',
                    task: 'Generate 5 brand images with Imagen4',
                    link: '/admin/image-generator',
                    done: false,
                  },
                  {
                    id: 'task-5',
                    task: 'Write and post first "Build in Public" tweet',
                    link: null,
                    done: false,
                  },
                  {
                    id: 'task-6',
                    task: 'Partner with first 3 billiard clubs for SABO Arena',
                    link: null,
                    done: false,
                  },
                  {
                    id: 'task-7',
                    task: 'Record first YouTube tutorial video',
                    link: null,
                    done: false,
                  },
                  {
                    id: 'task-8',
                    task: 'Set up Zalo OA for customer support',
                    link: null,
                    done: false,
                  },
                ].map((item) => (
                    ...
                    {item.link && (
                      <Button size="sm" variant="ghost" asChild>
                        <a
                          ...
                          aria-label={`Open link for ${item.task}`}
                        >
