...
import { AlertCircle, Copy, ExternalLink, Settings, Zap } from 'lucide-react';
...
import { CREDENTIAL_SUMMARY, PLATFORMS } from './constants';
...
export function FacebookTab({
  showTokens,
  copyToClipboard,
}: Omit<PlatformTabsProps, 'pendingPlatforms'>) {
  return (
