...
const SocialMediaConnections = lazy(() => import('./SocialMediaConnections'));
const ZaloOAManagement = lazy(() => import('./ZaloOAManagement'));
const ZaloCampaignDashboard = lazy(() => import('./ZaloCampaignDashboard'));
const FacebookMarketingDashboard = lazy(() => import('./FacebookMarketing'));
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="flex flex-wrap h-auto gap-1">
          ...
          <TabsTrigger value="schedule">
            <Activity className="w-4 h-4 mr-2" />📅 Schedule
          </TabsTrigger>
          ...
          <TabsTrigger value="zalo-campaigns">📢 Zalo Campaigns</TabsTrigger>
          <TabsTrigger value="facebook">👥 Facebook Marketing</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="zalo-campaigns">
          <Suspense
            fallback={
              <div className="flex justify-center py-12">
                <Loader2 className="h-6 w-6 animate-spin text-muted-foreground" />
