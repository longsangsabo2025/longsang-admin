          ...
          <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-4">
            ...
            {recentProjects[0] && (
              ...
              >
                ...
                <span className="truncate max-w-[120px]">{recentProjects[0].name}</span>
              </Button>
            )}
            <Button
              variant="outline"
        ...
        <CardContent className="pt-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Click vào bất kỳ dự án nào để xem chi tiết và quản lý nội dung. Bạn có quyền chỉnh
                sửa các dự án được phân quyền. Nếu cần thêm dự án, hãy liên hệ Admin.
              </p>
            </div>
          </div>
        </CardContent>
