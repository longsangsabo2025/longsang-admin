    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Duration: {selectedEpisode?.duration}s</DialogDescription>
        </DialogHeader>
            ...
            <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
              ...
              {isEditingScript ? (
                ...
                <p className="text-sm whitespace-pre-wrap">
                  {renderContent(selectedEpisode.story)}
                </p>
              )}
            </div>
            ...
            <div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
              ...
              {isEditingScript ? (
                <Textarea
                  ...
                  onChange={(e) =>
                    setEditedScript((prev) => ({ ...prev, punchline: e.target.value }))
                  }
                ...
                <p className="text-sm whitespace-pre-wrap">
                  {renderContent(selectedEpisode.punchline)}
                </p>
              )}
            </div>
            ...
            <div className="p-4 rounded-lg bg-purple-500/10 border border-purple-500/20">
              ...
              {isEditingScript ? (
                <Textarea
                  ...
                  onChange={(e) =>
                    setEditedScript((prev) => ({ ...prev, visualNotes: e.target.value }))
                  }
                  className="min-h-[80px] bg-background"
                ...
                <p className="text-sm whitespace-pre-wrap">
                  {renderContent(selectedEpisode.visualNotes)}
                </p>
              )}
            </div>
          </div>
        ...
        <DialogFooter className="gap-2">
          {!isEditingScript ? (
            ...
            <>
              ...
              <Button onClick={onSaveScript} disabled={isSaving}>
                {isSaving ? (
