...
import { AlertCircle, FileText, Image as ImageIcon, Loader2, Video, Wand2 } from 'lucide-react';
...
import { CONTENT_TEMPLATES, GENERATION_STYLES, PLATFORM_CONFIGS } from './constants';
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {CONTENT_TEMPLATES.map((template) => (
                ...
                >
                  ...
                  <div className="text-xs opacity-70 mt-1">
                    {template.duration}s •{' '}
                    {PLATFORM_CONFIGS[template.platform as keyof typeof PLATFORM_CONFIGS]?.icon ||
                      '🌐'}{' '}
                    {template.platform}
                  </div>
                </button>
      ...
      <Card className="lg:col-span-2">
        <CardHeader>
          ...
          <CardDescription>Create AI-generated content with your avatar</CardDescription>
        </CardHeader>
