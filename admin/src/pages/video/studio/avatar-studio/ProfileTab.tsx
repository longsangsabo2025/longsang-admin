    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Define who your AI avatar represents</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-2">
            ...
            <Button variant="outline" onClick={onShowCharacterPicker} className="flex-1">
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center p-4 bg-orange-50 dark:bg-orange-950 rounded-lg">
              <div className="text-3xl font-bold text-orange-600">{CONTENT_TEMPLATES.length}</div>
