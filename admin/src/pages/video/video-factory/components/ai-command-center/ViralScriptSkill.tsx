    ...
    <div className="space-y-4">
      <Card className="border-red-500/20">
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Generate complete viral video scripts with hooks, scenes, CTAs, and AI prompts
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            <div className="md:col-span-2 space-y-1">
              ...
              <Input
                placeholder="e.g. AI Facts, Motivation, Real Estate..."
                value={vsNiche}
                onChange={(e) => setVsNiche(e.target.value)}
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <Input
                ...
                max={10}
                value={vsCount}
                onChange={(e) => setVsCount(parseInt(e.target.value, 10) || 3)}
              />
            </div>
          </div>
          <div className="space-y-1">
            ...
            <Input
              placeholder="e.g. Mind-blowing AI predictions for 2026..."
              value={vsTopic}
              onChange={(e) => setVsTopic(e.target.value)}
            />
          </div>
          <Button
            className="w-full gap-2"
            disabled={loading || !vsNiche.trim()}
            onClick={onGenerate}
          >
            {loading ? (
              <>
              ...
              <>
                <Flame className="h-4 w-4" /> Generate Viral Scripts
              </>
            )}
          </Button>
        </CardContent>
              ...
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge
                      className={`text-xs ${(script.viral_score || 0) >= 8 ? 'bg-red-600' : 'bg-orange-500'}`}
                    >
                  ...
                  {script.hook_visual && (
                    <div className="mt-2 flex items-center gap-2">
                      ...
                      <Button
                        ...
                        onClick={() => copyToClipboard(script.hook_visual)}
                      >
