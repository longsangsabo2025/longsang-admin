...
import { Crown, Flame, Image as ImageIcon, Star, Target } from 'lucide-react';
...
export const MODEL_INTELLIGENCE: Record<string, ModelMeta> = {
  'minimax-hailuo': {
    ...
    tier: 'primary',
    type: 'video',
    provider: 'MiniMax (via Higgsfield)',
    maxResolution: '1080p',
    maxDuration: '6s',
    speed: 9,
    quality: 8,
  ...
  kling3: {
    ...
    tier: 'premium',
    type: 'video',
    provider: 'Kuaishou (via Higgsfield)',
    maxResolution: '4K',
    maxDuration: '15s',
    speed: 5,
    quality: 10,
  ...
  sora2: {
    ...
    tier: 'experimental',
    type: 'video',
    provider: 'OpenAI (via Higgsfield)',
    maxResolution: '1080p',
    maxDuration: '20s',
    speed: 3,
    quality: 9,
  ...
  veo31: {
    ...
    tier: 'experimental',
    type: 'video',
    provider: 'Google (via Higgsfield)',
    maxResolution: '1080p',
    maxDuration: '8s',
    speed: 5,
    quality: 8,
  ...
  'wan25-fast': {
    ...
    tier: 'experimental',
    type: 'video',
    provider: 'Alibaba (via Higgsfield)',
    maxResolution: '1080p',
    maxDuration: '5s',
    speed: 8,
    quality: 6,
  ...
  'flux2-pro': {
    ...
    tier: 'premium',
    type: 'image',
    provider: 'Black Forest Labs (via Higgsfield)',
    maxResolution: '4K',
    maxDuration: 'N/A',
    speed: 7,
    quality: 9,
  ...
  'higgsfield-faceswap': {
    id: 'higgsfield-faceswap',
    name: 'Higgsfield FaceSwap',
    tier: 'niche',
    type: 'image',
    provider: 'Higgsfield',
    maxResolution: '1080p',
...
> = {
  primary: {
    ...
    description: 'Production workhorse — 80% of output',
  },
  premium: {
    label: '💎 Premium',
    color: 'bg-purple-500/10 text-purple-600 border-purple-500/30',
    icon: React.createElement(Star, { className: 'h-3.5 w-3.5' }),
    description: 'Hero content — highest quality',
  },
  niche: {
    label: '🎯 Niche',
    color: 'bg-blue-500/10 text-blue-600 border-blue-500/30',
    icon: React.createElement(Target, { className: 'h-3.5 w-3.5' }),
    description: 'Specialized use cases',
  },
  experimental: {
    label: '🧪 Experimental',
    color: 'bg-orange-500/10 text-orange-600 border-orange-500/30',
    icon: React.createElement(Flame, { className: 'h-3.5 w-3.5' }),
