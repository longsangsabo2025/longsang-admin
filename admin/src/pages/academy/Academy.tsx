import { AlertCircle, Flame, GraduationCap, Search, Target, Trophy, Zap } from 'lucide-react';
import { useState } from 'react';
import { BadgeUnlockCelebration } from '@/components/academy/BadgeDisplay';
...
import { LevelUpCelebration } from '@/components/academy/XPDisplay';
...
export default function AcademyGaming() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <LevelUpCelebration level={newLevel} isOpen={showLevelUp} onClose={dismissLevelUp} />
      ...
      <main className="ml-0 xl:ml-[280px] mr-0 xl:mr-[300px] pt-[70px] px-6 pb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 animate-fade-in">
          <GamingStatsCard
            ...
            change={`Level ${xpSummary?.level || 1}`}
            trend="up"
          />
          <GamingStatsCard
            icon={Trophy}
            ...
            <GamingHeroSection
              ...
              instructor={
                typeof featuredCourse.instructor === 'object'
                  ...
                  : featuredCourse.instructor || 'AINewbieVN Expert Team'
              }
