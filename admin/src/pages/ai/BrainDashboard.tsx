...
const BulkOperations = lazy(() =>
  import('@/brain/components/BulkOperations').then((m) => ({ default: m.BulkOperations }))
);
const DomainManager = lazy(() =>
  import('@/brain/components/DomainManager').then((m) => ({ default: m.DomainManager }))
);

import { DocumentationViewer } from '@/brain/components/DocumentationViewer';

const KnowledgeIngestion = lazy(() =>
  import('@/brain/components/KnowledgeIngestion').then((m) => ({ default: m.KnowledgeIngestion }))
);
const YouTubeHarvester = lazy(() =>
  import('@/brain/components/YouTubeHarvester').then((m) => ({ default: m.YouTubeHarvester }))
);
const NewsHarvester = lazy(() =>
  import('@/brain/components/NewsHarvester').then((m) => ({ default: m.NewsHarvester }))
);
const SocialHarvester = lazy(() =>
  import('@/brain/components/SocialHarvester').then((m) => ({ default: m.SocialHarvester }))
);
const FileHarvester = lazy(() =>
  import('@/brain/components/FileHarvester').then((m) => ({ default: m.FileHarvester }))
);
const AudioHarvester = lazy(() =>
  import('@/brain/components/AudioHarvester').then((m) => ({ default: m.AudioHarvester }))
);
const KnowledgeManager = lazy(() =>
  import('@/brain/components/KnowledgeManager').then((m) => ({ default: m.KnowledgeManager }))
);
const KnowledgeSearch = lazy(() =>
  import('@/brain/components/KnowledgeSearch').then((m) => ({ default: m.KnowledgeSearch }))
);
const MultiDomainQuery = lazy(() =>
  import('@/brain/components/MultiDomainQuery').then((m) => ({ default: m.MultiDomainQuery }))
);
const MasterBrainInterface = lazy(() =>
  import('@/brain/components/MasterBrainInterface').then((m) => ({
    default: m.MasterBrainInterface,
  }))
);
const KnowledgeGraphVisualizer = lazy(() =>
  import('@/brain/components/KnowledgeGraphVisualizer').then((m) => ({
    default: m.KnowledgeGraphVisualizer,
  }))
);
const DomainRouter = lazy(() =>
  import('@/brain/components/DomainRouter').then((m) => ({ default: m.DomainRouter }))
);
const ImageBrainLibrary = lazy(() =>
  import('@/brain/components/ImageBrainLibrary').then((m) => ({ default: m.ImageBrainLibrary }))
);
        ...
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Your Personal Knowledge Operating System</p>
            </div>
          </div>
