...
const MorningBriefing = lazy(() =>
  import('@/components/command-center/MorningBriefing').then((m) => ({
    default: m.MorningBriefing,
  }))
);
const AgentOrchestrator = lazy(() =>
  import('@/components/command-center/AgentOrchestrator').then((m) => ({
    default: m.AgentOrchestrator,
  }))
);
const DecisionQueue = lazy(() =>
  import('@/components/command-center/DecisionQueue').then((m) => ({ default: m.DecisionQueue }))
);
const AgentMemory = lazy(() =>
  import('@/components/command-center/AgentMemory').then((m) => ({ default: m.AgentMemory }))
);
const AIChatPanel = lazy(() =>
  import('@/components/command-center/AIChatPanel').then((m) => ({ default: m.AIChatPanel }))
);

import { useAgentStats, useUnreadCount } from '@/hooks/use-agent-company';
