          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                ...
                <code className="bg-muted px-1 rounded text-xs">app_settings</code> table and used
                by Postgres triggers to send real-time notifications.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {telegramLoading ? (
                ...
                <>
                  <div className="p-4 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg">
                    <p className="text-sm text-blue-900 dark:text-blue-200">
                      <strong>How it works:</strong> When a pipeline run completes, fails, or hits
                      cost limit, a <strong>Postgres trigger</strong> reads these credentials and
                      sends a Telegram message via{' '}
                      <code className="bg-blue-100 dark:bg-blue-900 px-1 rounded">pg_net</code> —
                      zero Edge Functions, zero polling.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-muted-foreground">
                      Group chat: starts with <code>-100</code>. Personal: numeric ID. Get via{' '}
                      <a
