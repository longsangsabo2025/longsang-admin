import { BarChart3, Bot, Play, Store, Workflow, Wrench } from 'lucide-react';
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold mb-1 text-white">
                Admin Management - AI Agent Center
              </h1>
              <p className="text-slate-300">
                Dành cho <strong className="text-indigo-400">Admin/Developer</strong> - Quản lý
                agents, workflows, tools +{' '}
                <strong className="text-green-400">🛒 Marketplace AI thật</strong>
              </p>
              <p className="text-sm text-slate-400 mt-2">
                💡 <strong>Marketplace:</strong> 5 AI agents sẵn sàng với GPT-4o-mini
                ($0.01-$0.50/run) | <strong>Management:</strong> CRUD agents, build workflows,
                analytics
              </p>
            </div>
          </div>
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-slate-400">Orchestrate, monitor, and manage your AI agents</p>
            </div>
          </div>
        </div>
