    ...
    sections: [
      {
        ...
        fields: [
          ...
          {
            key: 'youtube.voice_ref_path',
            label: 'Voice Reference File Path',
            type: 'text',
            placeholder: '/path/to/voice_ref.wav',
          },
          {
            key: 'youtube.max_cost_per_video',
            label: 'Max Cost Per Video ($)',
            type: 'number',
            default: 0.5,
          },
        ],
      },
      {
        ...
        fields: [
          {
            key: 'youtube.auto_upload',
            label: 'Auto-upload to YouTube',
            type: 'toggle',
            default: false,
          },
          {
            key: 'youtube.oauth_client_id',
            label: 'YouTube OAuth Client ID',
            type: 'masked',
            placeholder: '...',
          },
          {
            key: 'youtube.oauth_client_secret',
            label: 'YouTube OAuth Client Secret',
            type: 'masked',
            placeholder: '...',
          },
          {
            key: 'youtube.oauth_refresh_token',
      ...
      },
      {
        ...
        fields: [
          {
            key: 'youtube.content_repurpose',
            label: 'Content Repurpose Enabled',
            type: 'toggle',
            default: false,
          },
          {
            key: 'youtube.telegram_enabled',
            label: 'Telegram Notifications Enabled',
            type: 'toggle',
            default: false,
          },
          {
            key: 'youtube.telegram_chat_id',
    ...
    sections: [
      {
        ...
        fields: [
          {
            key: 'vtdream.supabase_url',
            label: 'Supabase URL',
            type: 'text',
            placeholder: 'https://xxx.supabase.co',
          },
          {
            key: 'vtdream.vercel_url',
            label: 'Vercel Deploy URL',
            type: 'text',
            placeholder: 'https://vungtauland.store',
          },
          {
            key: 'vtdream.ga_tracking_id',
            label: 'GA Tracking ID',
            type: 'text',
            placeholder: 'G-XXXXXXXXXX',
          },
          {
            key: 'vtdream.sentry_dsn',
            label: 'Sentry DSN',
            type: 'text',
    ...
    sections: [
      {
        ...
        fields: [
          {
            key: 'sabo.supabase_url',
            label: 'Supabase URL (separate instance)',
            type: 'text',
            placeholder: 'https://xxx.supabase.co',
          },
          {
          ...
          {
            key: 'sabo.ga_tracking_id',
            label: 'GA Tracking ID',
            type: 'text',
            default: 'G-96E9M5KCFY',
          },
          {
            key: 'sabo.sentry_dsn',
            label: 'Sentry DSN',
            type: 'text',
            placeholder: 'https://xxx@sentry.io/xxx',
            description: 'Currently missing — needs setup',
          },
          {
            key: 'sabo.momo_partner_code',
            label: 'MoMo Partner Code',
            type: 'masked',
            placeholder: 'MoMo partner code',
          },
          {
            key: 'sabo.momo_access_key',
            label: 'MoMo Access Key',
            type: 'masked',
            placeholder: 'MoMo access key',
          },
          {
            key: 'sabo.momo_secret_key',
    ...
    sections: [
      {
        ...
        fields: [
          {
            key: 'longsang.supabase_url',
            label: 'Supabase URL',
            type: 'text',
            placeholder: 'https://xxx.supabase.co',
          },
          {
            key: 'longsang.stripe_publishable_key',
            label: 'Stripe Publishable Key',
            type: 'masked',
            placeholder: 'pk_live_...',
          },
          {
            key: 'longsang.stripe_secret_key',
            label: 'Stripe Secret Key',
            type: 'masked',
            placeholder: 'sk_live_...',
          },
          {
            key: 'longsang.vnpay_merchant_id',
            label: 'VNPay Merchant ID',
            type: 'masked',
            placeholder: 'Merchant ID',
          },
          {
            key: 'longsang.vnpay_hash_secret',
            label: 'VNPay Hash Secret',
            type: 'masked',
            placeholder: 'Hash secret',
          },
          {
            key: 'longsang.vnpay_payment_url',
            label: 'VNPay Payment URL',
            type: 'text',
            placeholder: 'https://sandbox.vnpayment.vn/paymentv2/vpcpay.html',
          },
          {
            key: 'longsang.ga_tracking_id',
            label: 'GA Tracking ID',
            type: 'text',
            placeholder: 'G-XXXXXXXXXX',
          },
          {
            key: 'longsang.domain_status',
            label: 'Domain Setup Status',
            type: 'text',
    ...
    sections: [
      {
        ...
        fields: [
          {
            key: 'ainewbie.supabase_url',
            label: 'Supabase URL',
            type: 'text',
            placeholder: 'https://xxx.supabase.co',
          },
          {
            key: 'ainewbie.supabase_anon_key',
            label: 'Supabase Anon Key',
            type: 'masked',
            placeholder: 'eyJ...',
          },
          {
            key: 'ainewbie.vercel_deploy_status',
            label: 'Vercel Deploy Status',
            type: 'text',
            placeholder: 'deployed / building / error',
          },
          {
            key: 'ainewbie.ga_tracking_id',
            label: 'GA Tracking ID',
            type: 'text',
            placeholder: 'G-XXXXXXXXXX',
          },
          {
            key: 'ainewbie.deploy_command',
            label: 'Deploy Command',
            type: 'readonly',
            default: 'npx vercel --prod',
          },
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        fields: [
          {
            key: 'infra.supabase_shared_url',
            label: 'Supabase Shared Instance URL',
            type: 'text',
            placeholder: 'https://xxx.supabase.co',
          },
          {
          ...
          {
            key: 'infra.voxcpm_tts_url',
            label: 'VoxCPM TTS URL',
            type: 'text',
            default: 'http://localhost:8100',
          },
          {
            key: 'infra.comfyui_url',
            label: 'ComfyUI URL',
            type: 'text',
            default: 'http://localhost:8188',
          },
          {
            key: 'infra.api_gateway_url',
...
export default function ProductSettings() {
  ...
  const saveCategory = async (categoryId: string) => {
    ...
    try {
      ...
      const { error } = await supabase
        .from('app_settings')
        .upsert(rows, { onConflict: 'key' } as any);
  ...
  const infraUrlKeys =
    PRODUCTS.find((p) => p.id === 'infrastructure')?.sections.flatMap((s) =>
      s.fields.filter((f) => f.key.includes('url')).map((f) => f.key)
    ) ?? [];
