...
import { calculateICE, EISENHOWER_QUADRANTS, TASK_CATEGORIES } from '@/types/survival.types';
    ...
    createTask.mutate(
      {
        ...
        confidence,
        ease,
        potential_revenue: potentialRevenue ? parseInt(potentialRevenue, 10) : undefined,
  ...
  return (
    <>
      <DialogHeader>
        ...
        <DialogDescription>Điền thông tin task theo Eisenhower + ICE Scoring</DialogDescription>
      </DialogHeader>
      ...
      <div className="space-y-4 py-4">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Badge className="text-lg px-3 py-1">Score: {iceScore}</Badge>
          </div>
