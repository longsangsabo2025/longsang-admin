...
import { EISENHOWER_QUADRANTS, type SurvivalTask, TASK_CATEGORIES } from '@/types/survival.types';
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          <span className={cn('font-medium truncate', size === 'large' && 'text-lg')}>
            {task.title}
          </span>
      ...
      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
        <Button variant="ghost" size="icon" className="h-8 w-8" onClick={onFocus}>
