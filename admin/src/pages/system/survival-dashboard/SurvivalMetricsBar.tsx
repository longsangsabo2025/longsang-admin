import { Brain, Clock, DollarSign, Flame, Target } from 'lucide-react';
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <div className="text-3xl font-bold mt-1">${metrics.targetAmount.toLocaleString()}</div>
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <div className="text-3xl font-bold mt-1 text-orange-500">${metrics.dailyTarget}</div>
        </CardContent>
      </Card>
