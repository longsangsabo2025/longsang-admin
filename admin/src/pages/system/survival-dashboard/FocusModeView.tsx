import { CheckCircle2, Coffee, DollarSign, Focus, Pause, Play, SkipForward } from 'lucide-react';
import { useEffect, useState } from 'react';
import { Badge } from '@/components/ui/badge';
import { Button } from '@/components/ui/button';
import { Card, CardContent } from '@/components/ui/card';
import { type SurvivalTask, TASK_CATEGORIES } from '@/types/survival.types';
...
export function FocusModeView({ task, onComplete, onExit, onSkip }: FocusModeViewProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-lg w-full space-y-8 text-center">
        {/* Exit Button */}
        <Button variant="ghost" className="absolute top-4 left-4" onClick={onExit}>
          ← Thoát Focus Mode
        </Button>
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <Button size="lg" className="bg-green-500 hover:bg-green-600" onClick={onComplete}>
