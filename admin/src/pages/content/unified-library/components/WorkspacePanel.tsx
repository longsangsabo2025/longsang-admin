...
import type { ProductStatus, WorkspaceItem } from '@/hooks/library';
...
export interface WorkspacePanelProps {
  ...
  setScheduleImage: (
    img: { url: string; name?: string; description?: string; tags?: string[] } | null
  ) => void;
                        ...
                        >
                          ...
                          <div className="p-2">
                            ...
                            <p className="text-xs text-muted-foreground mt-1">
                              Thêm lúc{' '}
                              {format(new Date(item.addedAt), 'HH:mm dd/MM', { locale: vi })}
                            </p>
                          </div>
                        </div>
                      </ContextMenuTrigger>
