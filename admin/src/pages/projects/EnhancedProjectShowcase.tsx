...
import { BarChart3, Grid, Layers, Menu, Search as SearchIcon, X } from 'lucide-react';
...
import { ProjectFilters, SearchBar } from '@/components/SearchBar';
...
const EnhancedProjectShowcase: React.FC = () => {
  ...
  const legacyActiveProject =
    projectsData.find((p) => p.id === parseInt(activeProjectId, 10)) || projectsData[0];
