...
export const OWNER_PROFILE = {
  ...
  name: 'Long Sang',
  description:
    'Solo Founder & Full-Stack Developer. Vietnamese male, professional and approachable appearance. Building AI-powered automation tools.',
  ...
  attributes: {
    ...
    bodyType: 'Average',
    height: 'Average',
    distinctiveFeatures: ['Friendly smile', 'Professional demeanor', 'Tech-savvy appearance'],
  },
  preferredStyles: ['Business casual', 'Smart casual', 'Tech entrepreneur style'],
  preferredOutfits: [
    'Polo shirt',
    'Button-down shirt',
  ...
  negativePromptKeywords: ['blurry', 'distorted', 'low quality', 'cartoon', 'anime', 'disfigured'],
  isOwner: true,
...
export const SABO_LOCATION = {
  ...
  description:
    'Modern billiard club with professional atmosphere. Features multiple pool tables, good lighting, and social gaming environment.',
  type: 'indoor',
  referenceImageIds: [],
  attributes: {
  ...
  negativePromptKeywords: ['dirty', 'old', 'dark', 'run-down', 'empty', 'blurry'],
  createdAt: new Date().toISOString(),
  updatedAt: new Date().toISOString(),
};
...
export const WORKSPACE_LOCATION = {
  ...
  description:
    'Modern home office or co-working space setup for full-stack development and content creation.',
  type: 'indoor',
  referenceImageIds: [],
  attributes: {
  ...
  negativePromptKeywords: ['messy', 'cluttered', 'dark', 'old equipment', 'blurry'],
  createdAt: new Date().toISOString(),
  updatedAt: new Date().toISOString(),
};
...
export const BRAND_STYLE = {
  ...
  promptTemplates: {
    headshot:
      'Professional headshot of Vietnamese male developer, confident smile, wearing {outfit}, gradient blue-purple background, high quality, 4K',
    workspace:
      'Modern developer workspace with multiple monitors, clean minimalist setup, natural lighting, professional atmosphere',
    socialBanner:
      'Twitter/LinkedIn banner, modern tech aesthetic, gradient blue to purple, minimalist design, "AI-Powered Automation" text',
  },
  createdAt: new Date().toISOString(),
  updatedAt: new Date().toISOString(),
};
...
export async function seedBrandData() {
  ...
  try {
    ...
    for (const location of locations) {
      const { error } = await supabase.from('brain_location_profiles').upsert(location);
