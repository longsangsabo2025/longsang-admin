    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Xem và chỉnh sửa thông tin ảnh đã được AI phân tích</DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-4">
            ...
            <Card className="bg-muted/50">
              <CardContent className="p-3 text-xs space-y-1">
                <p>
                  <span className="text-muted-foreground">Đã sử dụng:</span> {image.useCount} lần
                </p>
                <p>
                  <span className="text-muted-foreground">Chất lượng:</span>{' '}
                  {image.analysis.quality.overall}
                </p>
                <p>
                  <span className="text-muted-foreground">Phân tích lúc:</span>{' '}
                  {new Date(image.analyzedAt).toLocaleString()}
                </p>
              </CardContent>
            </Card>
          </div>
