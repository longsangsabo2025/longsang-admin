...
import { Check, Edit, Image as ImageIcon, Star, StarOff, Trash2, User } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-2 left-2">
        <Badge
          className={cn('text-white text-xs', CATEGORY_COLORS[image.analysis.primaryCategory])}
        >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-2 opacity-0 group-hover:opacity-100 transition-opacity">
        ...
        <div className="flex gap-1">
          ...
          >
            {image.isFavorite ? <StarOff className="w-3 h-3" /> : <Star className="w-3 h-3" />}
          </Button>
          <Button
            size="sm"
            variant="destructive"
