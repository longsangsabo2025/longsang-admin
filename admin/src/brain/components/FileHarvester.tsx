    ...
    <div className="space-y-6">
      <Tabs defaultValue="upload" className="space-y-4">
        ...
        <TabsContent value="upload">
          <FileUploader domains={domains || []} selectedDomainId={selectedDomainId} />
        </TabsContent>
        ...
        <TabsContent value="code">
          <CodeFileAnalyzer domains={domains || []} selectedDomainId={selectedDomainId} />
        </TabsContent>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Kết nối Google Drive để auto-sync documents</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {!connected ? (
          ...
          <div className="space-y-4">
            <Alert>
              ...
              <AlertDescription>Đã kết nối với Google Drive</AlertDescription>
            </Alert>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Phân tích và extract knowledge từ code repositories</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        {/* Domain Selection */}
        <div className="space-y-2">
